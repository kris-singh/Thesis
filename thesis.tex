...
Finding such a $h(x)$ is not trivial and sometimes not possible for many problems. We now look at the most popular variance reduction technique in literature. 
...
This are the major reason we prefer to use importance sampling in our work instead of the other two methods described above.
